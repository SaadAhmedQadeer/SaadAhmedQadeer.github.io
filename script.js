/* Saad Ahmed Qadeer — portfolio v2 */
...
(() => {
  ...
  /* Listen for system theme change only if user hasn't manually chosen */
  ...
  const targets = document.querySelectorAll(
    '.section__head, .about, .exp__item, .project, .teach__card, .award, .stack__group, .contact__email, .contact__socials, .display'
  );
